...
export default class CSS__Tree_View {
    ...
    css_rules__standard() {
        return {
            ".tree-view"             : { display: "flex", flexDirection: "column", padding: "1rem"                    },

            //".tree-item"             : { display: "flex", alignItems: "center", padding: "0.25rem", cursor: "pointer" },
            ".tree-item"             : {  alignItems: "center", padding: "0.25rem", cursor: "pointer" },

            ".tree-item:hover"       : { backgroundColor: "var(--table-hover-bg, rgba(0,0,0,0.04))"                   },

            ".tree-item-content"     : { display: "flex", alignItems: "center", gap: "0.5rem"                         },

            ".tree-item-icon"        : { width: "1.5rem", height: "1.5rem", display: "flex", alignItems: "center"     },

            ".tree-item-text"        : { fontSize: "0.9rem", color: "var(--text-color, #333)"                         },
            ...
            ".tree-item-actions"     : { marginLeft: "auto", display: "none", gap: "0.5rem"                           },
